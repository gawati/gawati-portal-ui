    ...
    getTimeline(paramsObj) {
        ...
        axios.request({
            ...
            .then(response => {
                ...
                console.log("yelements is " + yElements_scatter_data);
...
renderListing = () => {
    ...
    let content = <
    DivTimelineListing lang = {
        this.props.match.params.lang
    } >
    <
    DivFeed >
    <
    SearchListPaginator pagination = {
        pagination
    }
    onChangePage = {
        (this.onChangePage)
...
render() {
    ...
    let content = <div className = { `main-col col-xs-12 col-lg-9 col-md-9 col-sm-12`} >
    < Tabs >
    <TabList >
    <Tab > {
        T("Document Results")
